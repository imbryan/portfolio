...
class LoginTestView(TestCase):
    def setUp(self):
        ...
        self.mock_failed_turnstile_response.json.return_value = {
            "success": False,
    ...
    @patch("requests.post")
    @patch("core.utils.turnstile_utils.validate_turnstile")
    def test_login_failed_turnstile_invalid(
        self, mock_validate_turnstile, mock_requests_post
    ):
    ...
    @patch("requests.post")
    @patch("core.utils.turnstile_utils.validate_turnstile")
    def test_login_failed_credentials_invalid(
        self, mock_validate_turnstile, mock_requests_post
    ):
        mock_requests_post.return_value = self.mock_successful_turnstile_response
        mock_validate_turnstile.return_value = self.mock_successful_turnstile_response
